...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mannn.todolist.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mannn.todolist.security.DomainUserDetailsService", "createSpringSecurityUser");
